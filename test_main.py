...
class TestMain(unittest.TestCase):
    ...
    def setUp(self):
        ...
        with sn.MongoDBConnection() as mongo:
            self.mongo = mongo
            self.user_collection = users.UserCollection(mongo)
            self.status_collection = user_status.UserStatusCollection(mongo)
    ...
    def test_init_status_collection(self):
        ...
        Author: Marcus Bakke
        '''
        user_status_collection = main.init_status_collection(self.mongo)
        ipdb.set_trace()
